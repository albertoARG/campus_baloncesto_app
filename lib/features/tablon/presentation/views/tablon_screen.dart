  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isInternal = post.isStaffOnly;
                return Card(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: isInternal ? BorderSide(color: Colors.orange.shade300, width: 1) : BorderSide.none,
                  ),
                  child: Padding(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    post.title,
                                    style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold, color: isInternal ? Colors.orange.shade900 : Theme.of(context).colorScheme.primary),
                                  ),
                                ],
                              ),
                            ),
                            if (isAdminOrCoach)
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirm == true) {
                                    await ref.read(tablonRepositoryProvider).deletePost(post.id);
                                    ref.invalidate(tablonPostsProvider);
                                  }
                                },
                              )
      ...
      floatingActionButton: isAdminOrCoach ? FloatingActionButton.extended(
        onPressed: () => context.push('/tablon/create'),
